...
class AClossFT2D:
    ...
    def mesh(self, ny):
        ...
        #self.posi_x = self.posi_x + coil.r_in_real
    ...
    def post_cal_power(self, timestep0, timestep1, amp=1):
        ...
        for i in range(len(self.coils)):
            ...
            startnum = endnum
        axe.set_xticks(axe.get_xticklabels( ))
        axe.set_xlabel('Turn number')
...
count_turns = 130
cellthickness = 133e-3/130
# r_in_real has to be set 0 or else incorrect physics, this model requires modification
r_inreal=100e-3
tf = 50000
solver.add_coil(1e-4,  1e-4 + cellthickness * count_turns, 0,count_turns,r_in_real = r_inreal)
solver.add_coil(1e-4, 1e-4+ cellthickness * count_turns, 0.0044,count_turns,r_in_real = r_inreal)
solver.add_coil(1e-4,1e-4 + cellthickness * count_turns, 0.0044*2, count_turns,r_in_real = r_inreal)
solver.add_coil(1e-4, 1e-4+cellthickness * count_turns, 0.0044*3, count_turns,r_in_real = r_inreal)
solver.add_coil(1e-4, 1e-4+cellthickness * count_turns, 0.0044*4, count_turns,r_in_real = r_inreal)
solver.add_coil(1e-4, 1e-4+cellthickness * count_turns, 0.0044*5, count_turns,r_in_real = r_inreal)
solver.add_coil(1e-4, 1e-4+cellthickness * count_turns, 0.0044*6, count_turns,r_in_real = r_inreal)
solver.mesh(15)
...
use_sym = False
#solver.plot_resultj(3, use_sym=use_sym)
#solver.plot_resultb(3, use_sym=use_sym)
#plt.plot()
#solver.post_cal_power(6, 12)
solver.plot_resultj(1000)
solver.plot_resultj(10000)
...
solver.plot_resultj(49000)
solver.plot_resultb(1000)
solver.plot_resultb(10000)
solver.plot_resultb(20000)
solver.plot_resultb(25000)
solver.plot_resultb(30000)
solver.plot_resultb(35000)
solver.plot_resultb(40000)
solver.plot_resultb(45000)
solver.plot_resultb(49000)
